document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = [
        // English Songs
        { id: 1, title: "Blinding Lights", artistId: 1, audioSrc: "audio/1.mp3", cover: "img/1.jpg", liked: false, language: 'english' },
        { id: 2, title: "God's Plan", artistId: 2, audioSrc: "audio/2.mp3", cover: "img/2.jpg", liked: true, language: 'english' },
        { id: 3, title: "Don't Start Now", artistId: 3, audioSrc: "audio/3.mp3", cover: "img/3.jpg", liked: false, language: 'english' },
        { id: 4, title: "Say So", artistId: 4, audioSrc: "audio/4.mp3", cover: "img/4.jpg", liked: false, language: 'english' },
        { id: 5, title: "HUMBLE.", artistId: 5, audioSrc: "audio/5.mp3", cover: "img/5.jpg", liked: true, language: 'english' },
        { id: 6, title: "Shape of You", artistId: 6, audioSrc: "audio/6.mp3", cover: "img/6.jpg", liked: false, language: 'english' },
        { id: 7, title: "bad guy", artistId: 7, audioSrc: "audio/7.mp3", cover: "img/7.jpg", liked: false, language: 'english' },
        { id: 8, title: "Circles", artistId: 8, audioSrc: "audio/8.mp3", cover: "img/8.jpg", liked: false, language: 'english' },
        // Hindi Songs
        { id: 9, title: "Kesariya", artistId: 9, audioSrc: "audio/9.mp3", cover: "img/9.jpg", liked: true, language: 'hindi' },
        { id: 10, title: "Raatan Lambiyan", artistId: 10, audioSrc: "audio/10.mp3", cover: "img/10.jpg", liked: false, language: 'hindi' },
        { id: 11, title: "Ghungroo", artistId: 11, audioSrc: "audio/11.mp3", cover: "img/11.jpg", liked: false, language: 'hindi' },
        { id: 12, title: "Apna Bana Le", artistId: 12, audioSrc: "audio/12.mp3", cover: "img/12.jpg", liked: false, language: 'hindi' },
        { id: 13, title: "Kalank", artistId: 13, audioSrc: "audio/13.mp3", cover: "img/13.jpg", liked: false, language: 'hindi' },
        { id: 14, title: "Shayad", artistId: 14, audioSrc: "audio/14.mp3", cover: "img/14.jpg", liked: true, language: 'hindi' },
        { id: 15, title: "Bekhayali", artistId: 15, audioSrc: "audio/15.mp3", cover: "img/15.jpg", liked: false, language: 'hindi' },
        { id: 16, title: "Makhna", artistId: 1, audioSrc: "audio/16.mp3", cover: "img/16.jpg", liked: false, language: 'hindi' },
        // Telugu Songs
        { id: 17, title: "ButtaBomma", artistId: 3, audioSrc: "audio/17.mp3", cover: "img/17.jpg", liked: false, language: 'telugu' },
        { id: 18, title: "Ramuloo Ramulaa", artistId: 4, audioSrc: "audio/18.mp3", cover: "img/18.jpg", liked: false, language: 'telugu' },
        { id: 19, title: "Samajavaragamana", artistId: 6, audioSrc: "audio/19.mp3", cover: "img/19.jpg", liked: false, language: 'telugu' },
        { id: 20, title: "Kalaavathi", artistId: 7, audioSrc: "audio/20.mp3", cover: "img/20.jpg", liked: false, language: 'telugu' },
        { id: 21, title: "Nee Kannu Neeli", artistId: 8, audioSrc: "audio/21.mp3", cover: "img/21.jpg", liked: false, language: 'telugu' },
        { id: 22, title: "Choosi Chudangane", artistId: 9, audioSrc: "audio/22.mp3", cover: "img/22.jpg", liked: false, language: 'telugu' },
        { id: 23, title: "Hamsa Naava", artistId: 10, audioSrc: "audio/23.mp3", cover: "img/23.jpg", liked: false, language: 'telugu' },
        { id: 24, title: "Inkem Inkem Kaavaale", artistId: 11, audioSrc: "audio/24.mp3", cover: "img/24.jpg", liked: false, language: 'telugu' },
        { id: 25, title: "Vachinde", artistId: 12, audioSrc: "audio/25.mp3", cover: "img/25.jpg", liked: false, language: 'telugu' },
        { id: 26, title: "Adiga Adiga", artistId: 13, audioSrc: "audio/26.mp3", cover: "img/26.jpg", liked: false, language: 'telugu' }
    ];
    ...
    function renderCards(songArray){
        ...
        songArray.forEach(song=>{
            ...
            const cardHTML=`
                <div class="col-6 col-md-4 col-lg-3 col-xl-2" data-original-index="${originalIndex}">
                    <div class="card">
    ...
    function setupEventListeners(){
        ...
        menuHome.addEventListener("click", e => { e.preventDefault(); showHomePage(true); });
    ...
    function renderTopArtists(){topArtistsContainer.innerHTML="";artists.forEach(artist=>{const artistHTML=`\n                <a href="#" class="artist-circle-item">\n                    <img src="${artist.image}" alt="${artist.name}">\n                    <span>${artist.name}</span>\n                </a>\n            `;topArtistsContainer.innerHTML+=artistHTML})}
    ...
    function showHomePage(e = false) {
        const t = { title: "Home", view: "home", activeMenu: menuHome };
        updateView(t, e);
    }
    ...
    function init() {
        // renderPlaylists is removed as playlists are gone
        renderTopArtists();
        setupEventListeners();
        updateVolumeDisplay();
        const e = { title: "Home", view: "home", activeMenu: menuHome };
        updateView(e, true);
    }
    init();
});